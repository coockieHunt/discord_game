...
function App() {
    ...
    const [AssciColor, setAssciColor] = useState("#f7cde4")
    ...
    return (
        <>
            ...
            {step === 4 ?
                <div className="catch">
                    <h1>Bien jouer c'est tout pour le moment. si vous voulez une suite mp moi. avec le code nextcode. 🚀</h1>
                </div>:
                <div className="catch">
